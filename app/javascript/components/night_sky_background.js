(function() {
  ...
  $.fn.nightSkySprites = function() {
    this.append($('<canvas class="night-sky-background__sprites-canvas"></canvas>'));
    setup(this);
  };
  ...
  window.initNightSkySprites = function() {
    var $container = $('.night-sky-background');
    if ($container.length > 0) {
      $container.nightSkySprites();
    }
  };
