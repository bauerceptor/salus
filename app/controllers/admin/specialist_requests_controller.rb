class Admin::SpecialistRequestsController < Admin::BaseController
  ...
  def approve
    ...
    respond_to do |format|
      format.html do
        redirect_to admin_specialist_requests_url, notice: "Specialist request approved successfully."
      end
    end
  end
  ...
  def reject
    ...
    respond_to do |format|
      format.html do
        redirect_to admin_specialist_requests_url, notice: "Specialist request rejected."
      end
    end
  end
