class DiseasePhotosController < BaseController
  ...
  def disease_photo_params
    params.expect(disease_photo: %i[image caption])
  end
  ...
  def set_breadcrumbs
    ...
    add_breadcrumb t(".breadcrumbs.index"), disease_photos_path(disease_id: @disease.id, locale: I18n.locale)

    case action_name.to_sym
    when :new, :create
      add_breadcrumb t(".breadcrumbs.new"), new_disease_photo_path(disease_id: @disease.id, locale: I18n.locale)
    end
  end
end
